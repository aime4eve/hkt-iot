...
typedef enum sfType { SF6, SF7, SF8, SF9, SF10, SF11, SF12 } sfType_t;
typedef enum bwType { BW62K, BW125K, BW250K, BW500K } bwType_t;
typedef enum crType { CR4_5, CR4_6, CR4_7, CR4_8 } crType_t;
