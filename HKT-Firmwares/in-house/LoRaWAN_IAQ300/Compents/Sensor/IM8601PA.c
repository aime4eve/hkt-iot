...
u32 readPIRData_AllBits()
{
    ...
    DEBUG_TRACE(LOG_TAG, "%s Success, 0x%04X, 0x%08X, Out Range: %d, Signal Voltage: %duV", __func__, data1, data2, pir_param.out_range,
                pir_param.signal_voltage);
