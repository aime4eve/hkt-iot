...
{
	static u8 tempBattery = 100;
	static u32 reportBatteryCnt = 0;

	// 总容量8Ah  静态功耗830uA 上报一次消耗 15uA
	reportBatteryCnt++;
	double value = ((8000000.0 - 830 * runHours - 15 * reportBatteryCnt) * 100 / 8000000);
	...
	// DEBUG_TRACE(LOG_TAG, "Get Battery Status %d, Level %d", batteryStatus, batteryLevel);
}
#endif
