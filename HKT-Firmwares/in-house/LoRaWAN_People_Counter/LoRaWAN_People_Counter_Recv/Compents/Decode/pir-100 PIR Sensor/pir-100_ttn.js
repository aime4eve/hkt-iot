 ...
 *   5. 字段名为破坏性变更（原 infraredStatus/antiTamperSwitch 等已废弃），
 *      平台侧规则/看板需同步映射。
...
// 手册示例：000104040c857d0077011701
console.log(Decoder([0x00, 0x01, 0x04, 0x04, 0x0c, 0x85, 0x7d, 0x00, 0x77, 0x01, 0x17, 0x01], 210));

// 供本地 Node 单元测试使用；平台 codec 沙箱中无 module，自动跳过
if (typeof module !== "undefined") {
    module.exports = { Decoder, easy_decode };
}
