...
{
    u16 retry = 0;
    char DevEUI_Str[] = "AT+DEVEUI= 00 95 69 06 00 00 D4 E1, D3 91 01 02 20 10 28 16, 1";
    // sprintf(DevEUI_Str, "AT+DEVEUI= %02x %02x %02x %02x %02x %02x %02x %02x, D3 91 01 02 20 10 28 16, 1",
    //         LoRaWAN.DevEUI[0], LoRaWAN.DevEUI[1], LoRaWAN.DevEUI[2], LoRaWAN.DevEUI[3], LoRaWAN.DevEUI[4], LoRaWAN.DevEUI[5], LoRaWAN.DevEUI[6],
    //         LoRaWAN.DevEUI[7]);
    while (retry < 3) {
