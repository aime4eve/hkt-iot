...
extern void  nz3801SetTimer2(u8 fwi);
extern u8    nz3801HwReset(void);
extern u8    nz3801SoftReset(void);
extern u8    nz3801SoftPwrDown(bool bEnable);
extern u8    nz3801ActivateField(bool activateField);
extern u8    nz3801Init(teCardType);

extern u8    nz3801Transceive(eCmd command, 
                    const u8 *request, u8 requestLength, u8 txalign, 
                          u8 *response, u8 *responseLength, u8 rxalign);
extern u8    nz3801IBLOCK(const u8 *inf, u16 infLength, 
