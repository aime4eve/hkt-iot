...
#define WDT_PRESCALER     (7)     /*!< 0: 1/1, 1: 1/2, 2: 1/4, 3: 1/8, 4: 1/16, 5: 1/32, 6: 1/64, 7: 1/128  */
#define WDT_RELOAD        (3750)  /*!< 0 ~ 4095, 12 bit   15秒                                                  */
